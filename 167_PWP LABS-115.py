...
# Student records
my_record = [
    (92400133167, 'Seshu Vardhan Reddy', 'PWP', 98),
    (92400133167, 'Seshu Vardhan Reddy', 'ICE', 95),
    (92400133167, 'Seshu Vardhan Reddy', 'DMGT', 92),
    (92400133167, 'Seshu Vardhan Reddy', 'DSC', 89),
    (92400133167, 'Seshu Vardhan Reddy', 'SS', 86),
    (92400133167, 'Seshu Vardhan Reddy', 'COA', 84)
]
cursor.executemany('''
...
cursor.execute('''
    UPDATE my_record 
    SET Mark = 98 
    WHERE Enrollment = 92400133167 AND Subject = 'COA'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 92400133167 AND Subject = 'SS'
''')
conn.commit()
